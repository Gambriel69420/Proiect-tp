...
// ma gandeam in engleza ca ma doare capul, bineinteles ca glumesc, m-am "inspirat" cu functia de heapsort
...
void afisare(int v[100000], int n, int k)
{
    ...
    j = 1;
    FILE* g;
    g = fopen("kmx.out", "wt");//deschiderea fisierului in care afisam datele
